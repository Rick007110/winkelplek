...
return [
    ...
    */
    ...
    | Livewire will communicate with this URL to send requests.
    |
    */
    ...
    */
    ...
    | some build systems, such as Vapor, you might want to change this.
    |
    */
    ...
    |
    | Setting it to "false" (default) disables back button cache.
    |
    */
